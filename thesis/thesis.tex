...
\lstdefinelanguage{Links}{% 
  morekeywords={spawn, receive, typename, fun, op, var, if, this, true, false, else, case, switch, handle, handler, shallowhandler, do, sig},%
  sensitive=t, % 
  keywordstyle=\color{red},
  emph={Comp,Player,Bool,Int,GTree,Cheat,Zero,Choose,Rand,Move,Winner,Take,Return,Get,Put,GameState,Alice,Bob,Fail,Nothing,Just,Maybe,Toss,Heads,Tails,Process},
...
\end{lstlisting}
%
Here, we have omitted the full error message for brevity, but the
essence of the problem is that the function \lstinline$(+)$ has type
\lstinline$(Int,Int) -> Int$ and \lstinline$Int$ and
\lstinline$Process({ |e })$ are incompatible types. This adds a layer
of safety to the concurrency model as we cannot erroneously refer to
an non-existent process.
%
...
% \tikzset{sarrow/.style={-latex,ultra thick,dotted}}
...
% \end{tikzpicture}
% \caption{Conceptual representation of Sieve of Eratosthenes.}\label{fig:sieve}
% \end{figure}
