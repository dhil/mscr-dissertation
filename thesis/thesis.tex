...
\lstdefinelanguage{Links}{% 
  ...
  emph={Comp,Player,Bool,Int,GTree,Cheat,Zero,Choose,Rand,Move,Winner,Take,Return,Get,Put,GameState,Alice,Bob,Fail,Nothing,Just,Maybe,Toss,Heads,Tails,Process,Buyer,Coffee,Pay,Cost},
...
and terminates afterwards. The process is only capable
of receiving strings but often we want to communicate via richer
types. To achieve this we can use polymorphic variants, e.g.
%
\begin{lstlisting}
...
\end{lstlisting}
