...
get our lunch for free anymore as clock frequencies no longer grow,
which is mainly due to physical issues such as excessive heat, power
...
computational device now comprise multiple processing
cores. Consequently, we are faced with the challenge of \emph{parallel
  programming}, i.e.  programming multiple computational cores to
