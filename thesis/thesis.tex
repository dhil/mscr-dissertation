...
\documentclass[mscres,icsalfcs,twoside,openright,logo,rightchapter,normalheadings]{infthesis}
...
\setcounter{tocdepth}{2} % Show chapters, sections and subsections in TOC
%\singlespace
\tableofcontents
%\doublespace
