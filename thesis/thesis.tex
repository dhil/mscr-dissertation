...
increase in performance, that software applications and developers
enjoyed for free for 30 years, due to the regular increase in
...
get to have our free lunch anymore as clock frequencies no longer
grow. It is mainly due to physical issues such as heat control, power
consumption and current leakage problems \citep{Sutter2005}. Instead
of increasing the clock frequency of processors, a single
computational device now comprise multiple several processing
cores. Consequently, we are faced with the challenge of \emph{parallel
  programming}, i.e.  programming multiple computational cores
simultaneously rather than a single core.

%

With the emergence of multicore and heterogeneous processors in
consumer-grade hardware, however, parallel programming has become a
discipline every software developer ought to know and master.
